...
lifecycle <- function(lifecycle) {
  ...
  if (lifecycle == "experimental") {
    return("![](https://img.shields.io/badge/Lifecycle-Experimental-339999)")
  } else if (lifecycle == "maturing") {
    return("![](https://img.shields.io/badge/Lifecycle-Maturing-007EC6)")
  } else if (lifecycle == "stable") {
    return("![](https://img.shields.io/badge/Lifecycle-Stable-97ca00)")
  } else if (lifecycle == "dormant") {
    return("![](https://img.shields.io/badge/Lifecycle-Dormant-ff7f2a)")
  } else if (lifecycle == "retired") {
    return("![](https://img.shields.io/badge/Lifecycle-Retired-d45500)")
  }
}
